...
public class MenuGUI {
	...
	private void initialize() {
		...
		lblNewLabel_11.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_12.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_13.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_14.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_15.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_16.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_17.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_18.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_19.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_20.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_21.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_22.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_23.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		lblNewLabel_24.setFont(new Font("휴먼모음T", Font.BOLD, 13));
		...
		panel_2.add(panel_30);
				...
				lblNewLabel_1.setFont(new Font("휴먼모음T", Font.BOLD, 17));
		...
		panel_2.add(panel_31);
				...
				lblNewLabel_2.setFont(new Font("휴먼모음T", Font.BOLD, 17));
		...
		panel_2.add(panel_32);
				...
				lblNewLabel_3.setFont(new Font("휴먼모음T", Font.BOLD, 17));
		...
		panel_2.add(panel_33);
				...
				lblNewLabel_4.setFont(new Font("휴먼모음T", Font.BOLD, 17));
		...
		btnNewButton_19.setFont(new Font("휴먼모음T", Font.BOLD, 25));
